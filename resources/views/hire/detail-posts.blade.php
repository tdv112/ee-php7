        ...
        <div class="col-md-7 contentpost">
            ...
            <div class="form-group">
                <div class="row">
                    ...
                    <div class="col-sm-11">
                        <input type="text" class="form-control" id="name" name="name" value="{{$post->name}}" placeholder="Ex. Bùi Huy Khương" readonly="readonly">
                    </div>
                </div>
            ...
            <div class="form-group">
                <div class="row">
                    ...
                    <div class="col-sm-11" style="padding-left: 0px;padding-right: 0px;">
                        <div class="col-xs-3">
                            <input type="text" class="form-control" id="phonezone" name="phonezone" value="{{$post->phone_area}}" placeholder="Ex. +84" readonly="readonly">
                        </div>
                        <div class="col-xs-9">
                            <input type="text" class="form-control" id="phone" name="phone" value="{{$post->phone}}" placeholder="Ex. 9768052285" readonly="readonly">
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="form-group">
                <div class="row">
                    ...
                    <div class="col-sm-11">
                        <input id="autocomplete" class="form-control" name="address" placeholder="Ex. 54 Nguyễn Thị Minh Khai, Q.1, TP HCM" type="text" value="{{$post->address}}" readonly="readonly">
            ...
            <div class="form-group">
                <div class="row">
                    ...
                    <div class="col-sm-11">
                        ...
                        <input type="text" class="form-control" value="{{$post->post_title}}" name="title" id="title" placeholder="Ex. Tuyển thợ cắt cỏ" readonly="readonly">
                    </div>
                </div>
            ...
            <div class="form-group">
                <div class="row">
                    ...
                    <div class="col-sm-11">
                        <span class="msg-item" id="msg_phone"></span>
                        <textarea class="form-control" rows="10" id="content" name="content" placeholder="Nhập nội dung bài đăng" readonly="readonly"> {{$post->post_content}}</textarea>
                    </div>
                </div>
